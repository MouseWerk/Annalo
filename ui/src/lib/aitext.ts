...
export function meetingSummaryInstruction(template?: string | null): string {
  ...
  return [
    ...
    "",
    "## Aufgaben",
    "Jede Aufgabe als eigene Zeile im Format `- [ ] Text @Person 📅 JJJJ-MM-TT`.",
    "@Person nur, wenn eine verantwortliche Person genannt ist. 📅 mit Datum nur, wenn ein Termin genannt ist; relative Angaben („bis Freitag“) in ein Datum umrechnen.",
