...
/// Number of global shortcut slots.
pub const SLOTS: usize = 4;
const ROLES: [Role; SLOTS] = [Role::Capture, Role::Palette, Role::Search, Role::Selection];
const ROLE_NAMES: [&str; SLOTS] = ["Schnellerfassung", "Befehlspalette", "Schnellsuche", "Auswahl übernehmen"];
...
pub struct Desktop {
    ...
    /// Registered global shortcuts by [`Role`]: capture, palette, search, selection.
...
/// Checks the shortcuts of the settings (capture, palette, search, selection; `""` = off) before saving.
